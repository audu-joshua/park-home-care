        ...
        <ScrollReveal direction="up">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 bg-white rounded-3xl shadow-sm border border-slate-100 p-8 sm:p-12">
            <div className="prose prose-slate prose-lg max-w-none
              ...
              <p>
                Park Home Health Agency LLC provides non-medical in-home care services including, but not limited to, personal hygiene assistance, companionship, meal preparation, mobility support, medication reminders, and specialized care for seniors and individuals with chronic conditions. Our services are provided in Raleigh, NC and surrounding areas.
              </p>
              ...
              <p>
                All our caregivers are thoroughly screened, background-checked, and trained. However, clients agree not to directly hire or privately engage any Park Home Health caregiver outside of the services provided by the Agency for a period of 12 months after the termination of the service agreement.
              </p>
              ...
              <ul>
                ...
                <li>Treat all Park Home Health staff with dignity and respect.</li>
              </ul>

              <h2>8. Limitation of Liability</h2>
              <p>
                Park Home Health Agency LLC provides non-medical care services and is not a licensed medical or clinical provider. We are not liable for any medical decisions, outcomes, or emergencies. In no event shall our liability exceed the total amount paid by the client for services in the three months preceding the event giving rise to a claim.
              </p>

              <h2>9. Indemnification</h2>
              <p>
                You agree to indemnify and hold harmless Park Home Health Agency LLC, its officers, directors, employees, and agents from and against any claims, liabilities, damages, losses, and expenses arising from your use of our services or violation of these Terms.
              </p>

              <h2>10. Intellectual Property</h2>
              <p>
                All content on our website, including text, graphics, logos, and images, is the property of Park Home Health Agency LLC and is protected by applicable intellectual property laws. You may not use, reproduce, or distribute any content without our express written permission.
              </p>
